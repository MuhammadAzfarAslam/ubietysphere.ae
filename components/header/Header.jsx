...
export default function Header() {
  ...
  const navItems = [
    { name: "Home", href: "/" },
    { name: "Knowledge Dome", href: "/knowledge-dome" },
    ...
    <header>
      ...
      >
        <div className="max-w-7xl container mx-auto" bis_skin_checked="1">
          ...
          >
            <div
              className="col-auto d-none d-lg-block text-xs"
              bis_skin_checked="1"
            >
              1010 Avenue, New York, NY 10018 US.{" "}
            </div>
            <div className="col-auto" bis_skin_checked="1">
              <button className=" hover:underline text-white px-8 rounded-md text-xs">
                Login
              </button>
            </div>
          </div>
