...
const FormButton = ({ additionalClass, children, ...props }) => {
  return (
    <button
      type="submit"
      {...props}
      className={`inline-block px-6 py-3 bg-primary cursor-pointer text-white font-medium rounded-sm shadow relative overflow-hidden group border-2 border-transparent hover:border-primary transition ${additionalClass}`}
    >
