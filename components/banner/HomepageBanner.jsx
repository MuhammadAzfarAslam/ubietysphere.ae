      ...
      >
        ...
        <div className="max-w-7xl container mx-auto flex h-full items-center justify-between px-4 sm:px-6 lg:px-8 relative z-30">
          ...
          <div className="lg:w-1/2 text-white">
            <h1 className="text-4xl font-semibold text-secondary mb-4">Get in Touch</h1>
            ...
            <a
              href="#contact"
              className="text-lg text-secondary border-b border-transparent hover:border-white"
            >
              Find More
            </a>
          </div>
